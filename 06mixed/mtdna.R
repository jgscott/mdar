...
# This ignores correlation due to litter
...
# tissue-level and litter-level effects
hlm1 = lmer(log2(copy) ~ (1 | tissue) + (1 | litter), data=mtdna1)
print(hlm1)
ranef(hlm1)
...
r2.tissue = ranef(hlm2, postVar=TRUE, whichel = 'tissue')
dotplot(r2.tissue)
